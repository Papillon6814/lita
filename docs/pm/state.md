...
- **最終更新**: 2026-09-22
- **フェーズ**: v0.2 の 3 柱（文体・記事・エディタ）を実装済み（D-44〜D-46、#49、PR #50〜#55）。本人のドッグフーディング中。配布（#25）は本人用の一周（GitHub Releases ＋ アプリ内更新、v0.2.2）まで完了。Apple 署名と Homebrew は保留（D-51）。ただし **2026-09-22 に保存方式が SQLite からサーバへ転換**（D-36〜D-39）。基盤は Supabase（D-40）
